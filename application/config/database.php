...
$db['db_colegiado']['hostname'] = '10.10.10.250';
$db['db_colegiado']['username'] = 'root';
$db['db_colegiado']['password'] = 'root';
...
$db['bdcampusvirtual']['password'] = 'root';
